...
# hierarchical
set.seed(9)
x=as.matrix(exac_grouped_ninety_wide_stat_pre[1:10,3:16])
...
set.seed(9)
y=as.matrix(exac_grouped_ninety_wide_stat[1:10,3:16])
...
hc_DTW <- tsclust(y, type = "fuzzy", k = 2, distance = "dtw", max.iter=9e+99, seed=9 )
plot(hc_DTW)
hc_DTW@cluster
